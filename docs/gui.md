...
3. Paste or append the configuration under the appropriate key in the master settings file in the Gambit repository: [build_support/catalog/efgviz_settings.yaml](https://github.com/gambitproject/gambit/blob/master/build_support/catalog/efgviz_settings.yaml).
